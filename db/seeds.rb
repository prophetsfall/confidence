...
if Week.all.length < 17
  ...
  Game.create!(week_id:Week.current_week.id, away_team_id: 1, home_team_id:2, gametime: DateTime.new(Date.tomorrow.year,Date.tomorrow.month, Date.tomorrow.day,Time.now.hour,Time.now.min, Time.now.sec))
  Game.create!(week_id:Week.current_week.id, away_team_id: 3, home_team_id:4, gametime: DateTime.new(Date.tomorrow.year,Date.tomorrow.month, Date.tomorrow.day,Time.now.hour,Time.now.min, Time.now.sec))
  Game.create!(week_id:Week.current_week.id, away_team_id: 5, home_team_id:6, gametime: DateTime.new(Date.tomorrow.year,Date.tomorrow.month, Date.tomorrow.day,Time.now.hour,Time.now.min, Time.now.sec))
  Game.create!(week_id:Week.current_week.id, away_team_id: 7, home_team_id:8, gametime: DateTime.new(Date.tomorrow.year,Date.tomorrow.month, Date.tomorrow.day,Time.now.hour,Time.now.min, Time.now.sec))
  Game.create!(week_id:Week.current_week.id, away_team_id: 11, home_team_id:12, gametime: DateTime.new(Date.tomorrow.year,Date.tomorrow.month, Date.tomorrow.day,Time.now.hour,Time.now.min, Time.now.sec))
  Game.create!(week_id:Week.current_week.id, away_team_id: 9, home_team_id:10, gametime: DateTime.new(Date.tomorrow.year,Date.tomorrow.month, Date.tomorrow.day,Time.now.hour,Time.now.min, Time.now.sec))
  Game.create!(week_id:Week.current_week.id, away_team_id: 13, home_team_id:14, gametime: DateTime.new(Date.tomorrow.year,Date.tomorrow.month, Date.tomorrow.day,Time.now.hour,Time.now.min, Time.now.sec))
  Game.create!(week_id:Week.current_week.id, away_team_id: 15, home_team_id:16, gametime: DateTime.new(Date.tomorrow.year,Date.tomorrow.month, Date.tomorrow.day,Time.now.hour,Time.now.min, Time.now.sec))
  Game.create!(week_id:Week.current_week.id, away_team_id: 17, home_team_id:18, gametime: DateTime.new(Date.tomorrow.year,Date.tomorrow.month, Date.tomorrow.day,Time.now.hour,Time.now.min, Time.now.sec))
  Game.create!(week_id:Week.current_week.id, away_team_id: 19, home_team_id:20, gametime: DateTime.new(Date.tomorrow.year,Date.tomorrow.month, Date.tomorrow.day,Time.now.hour,Time.now.min, Time.now.sec))
  Game.create!(week_id:Week.current_week.id, away_team_id: 21, home_team_id:22, gametime: DateTime.new(Date.tomorrow.year,Date.tomorrow.month, Date.tomorrow.day,Time.now.hour,Time.now.min, Time.now.sec))
  Game.create!(week_id:Week.current_week.id, away_team_id: 23, home_team_id:24, gametime: DateTime.new(Date.tomorrow.year,Date.tomorrow.month, Date.tomorrow.day,Time.now.hour,Time.now.min, Time.now.sec))
  Game.create!(week_id:Week.current_week.id, away_team_id: 25, home_team_id:26, gametime: DateTime.new(Date.tomorrow.year,Date.tomorrow.month, Date.tomorrow.day,Time.now.hour,Time.now.min, Time.now.sec))
  Game.create!(week_id:Week.current_week.id, away_team_id: 27, home_team_id:28, gametime: DateTime.new(Date.tomorrow.year,Date.tomorrow.month, Date.tomorrow.day,Time.now.hour,Time.now.min, Time.now.sec))
  Game.create!(week_id:Week.current_week.id, away_team_id: 29, home_team_id:30, gametime: DateTime.new(Date.tomorrow.year,Date.tomorrow.month, Date.tomorrow.day,Time.now.hour,Time.now.min, Time.now.sec))
  Game.create!(week_id:Week.current_week.id, away_team_id: 31, home_team_id:32, gametime: DateTime.new(Date.tomorrow.year,Date.tomorrow.month, Date.tomorrow.day,Time.now.hour,Time.now.min, Time.now.sec))
