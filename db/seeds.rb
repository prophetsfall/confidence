...
if Game.all.length <16
  Game.create!(week:Week.current_week, away_team_id: 1, home_team_id:2)
  Game.create!(week:Week.current_week, away_team_id: 3, home_team_id:4)
  Game.create!(week:Week.current_week, away_team_id: 5, home_team_id:6)
  Game.create!(week:Week.current_week, away_team_id: 7, home_team_id:8)
  Game.create!(week:Week.current_week, away_team_id: 9, home_team_id:10)
  Game.create!(week:Week.current_week, away_team_id: 11, home_team_id:12)
  Game.create!(week:Week.current_week, away_team_id: 13, home_team_id:14)
  Game.create!(week:Week.current_week, away_team_id: 15, home_team_id:16)
  Game.create!(week:Week.current_week, away_team_id: 17, home_team_id:18)
  Game.create!(week:Week.current_week, away_team_id: 19, home_team_id:20)
  Game.create!(week:Week.current_week, away_team_id: 21, home_team_id:22)
  Game.create!(week:Week.current_week, away_team_id: 23, home_team_id:24)
  Game.create!(week:Week.current_week, away_team_id: 25, home_team_id:26)
  Game.create!(week:Week.current_week, away_team_id: 27, home_team_id:28)
  Game.create!(week:Week.current_week, away_team_id: 29, home_team_id:30)
  Game.create!(week:Week.current_week, away_team_id: 31, home_team_id:32)
end
